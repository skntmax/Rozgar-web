...
import TemplateEdit02Form from '../../components/ResumeMaking/TemplateEdit02';
...
export default class TemplateEdit02 extends Component {
  ...
  componentDidMount() {
    // document.title = constant.title.TemplateEdit02
  }
  ...
  addResumeMaking = (model) => {
    ...
    WriteResume(model).then((res) => {
      ...
      if (res.status) {
        ...
        localStorage.setItem('CANDIDATE_ID', res.result.CANDIDATE_ID)
      }
      else {
        Swal.fire({
          icon: 'error',
