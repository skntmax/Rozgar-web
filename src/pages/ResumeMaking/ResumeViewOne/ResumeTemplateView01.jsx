...
import ResumeTemplateView01 from '../../../components/ResumeMaking/ResumeViewOne/ResumeTemplateView01'
...
export default class resumeTemplateView01 extends Component {
    ...
    componentDidMount(){
        document.title = constant.title.ResumeTemplateView01
    }
  render() {
    return (
      <React.Fragment>
