...
import ResumeTemplateView02 from '../../../components/ResumeMaking/ResumeViewOne/ResumeTemplateView02';
...
export default class resumeTemplateView02 extends Component {
  ...
  componentDidMount() {
    document.title = constant.title.ResumeViewOne
  ...
  // componentDidMount() {
  //   document.title = constant.title.ResumeTemplateView02
  // }

  render() {
    // console.log("candidatesssssss", this.state.candidateList);
    return (
      <React.Fragment>
        <Helmet >
