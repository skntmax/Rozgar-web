...
import { CommonQuestionById, interviewQuestionById, latestjobs } from '../../action/SkillsQuestionAction';
import CommonSearchAns from '../../components/InterviewQuestions/CommonSearchAns'
import constant from '../../constant'
import { capFirstLetterInSentence } from '../../utils';
export default class CommonSearchAnswer extends Component {
    constructor(props){
        super(props);
        this.state = {
          jobList:undefined,
