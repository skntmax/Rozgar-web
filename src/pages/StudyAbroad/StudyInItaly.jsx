...
import Italy from '../../components/StudyAbroad/StudyInItaly';
...
export default class StudyInItaly extends Component {
    ...
    componentDidMount(){
        document.title = constant.title.studyInItaly
    }
  render() {
    return (
      <React.Fragment>
...
<meta name="description" content={ capFirstLetterInSentence(window.location.pathname.replace('/','').split('/').pop().split('-').join(' ')) + " - Italy is a historic and beautiful country situated in the south-central part of Europe and consists of a peninsula bordered by the Alps and surrounded by several islands. Due to its strategically important location, Italy has historically been very important and has had a rich history."} />
