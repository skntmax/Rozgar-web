...
<meta name="description" content={ capFirstLetterInSentence(window.location.pathname.replace('/','').split('/').pop().split('-').join(' ')) + " - Ireland is a sovereign country on the island of Ireland, with its neighbour Northern Ireland being a part of the United Kingdom. Ireland is among the top ten wealthiest countries in the world in terms of GDP per capita"} />
