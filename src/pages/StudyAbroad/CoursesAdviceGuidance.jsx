...
import CoursesAdviceGuidance from '../../components/StudyAbroad/CoursesAdviceGuidance';
...
export default class coursesAdviceGuidance extends Component {
    ...
    componentDidMount(){
        document.title = constant.title.coursesAdviceGuidance
    }
  render() {
    return (
      <React.Fragment>
...
<meta name="description" content={ capFirstLetterInSentence(window.location.pathname.replace('/','').split('/').pop().split('-').join(' ')) + " - Once you have decided to pursue your studies outside India, it sometimes becomes difficult to make a choice among the so many different countries and universities that offer so many different courses, all of which have the potential to transform your career into a successful one"} />
