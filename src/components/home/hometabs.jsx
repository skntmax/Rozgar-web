...
export default class hometabs extends Component {
    ...
    render() {
                ...
                <section id="section1" className="rg-haslayout rg-sectionspace pt-0 pb-1">
                    <div className="container" id="container1">
                        <div className="row" >
                            <div className="col-lg-3">
                                <div className='roz-home-nav animated bounceInDown'>
                                    ...
                                    <div className="create-free-job-alert">
                                        ...
                                        <div className='create-job-alert-btn'>
                                            <Link to={constant.component.CreateJobAlert.url}>CREATE JOB ALERT</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-6">
                                <div className="roz-search-job">
                                    <div className="search-head">
                                        <h1 style={{fontSize:'20px'}}>Looking for a <span>Corporate</span> Job?</h1>
                                        ...
                                        <form onSubmit={this.onSearch} className="rg-formtheme rg-formbasicinfo">
                                            <fieldset>
                                                ...
                                                <div className="form-group rg-btnsarea mb-0">
                                                    <button type="submit" className="rg-btn rg-active btn-primary float-right" id="showtoast" style={{fontSize:'20px'}}>Search</button>
                                                </div>
                                            </fieldset>
                                        </form>
                                    </div>
                            ...
                            <div className="col-lg-3">
                                <div className='pm-rozgar-mela-section'>
                                    <a target='_blank' href={constant.component.PMRozgarMela.url}>
                                        <img src={pmrozgarmelapic} />
                                ...
                                <div className="roz-create-cv">
                                    <div className='urgent-hiring-area'>
                                        <Link to={constant.component.hiringfresherjob.url}>
        ...
        *************************************--> */}
                {/* <FeaturedSlider/> */}
                <section className='rg-haslayout pb-3 pt-4'>
                    <div className='container'>
                        <div className='row'>
                            <div className='col-md-12'>
                               <Link to={constant.component.hiringfresherjob.url}><img src={'./assets/images/fresher-jobs-ads.jpg'}/></Link>
                            </div>
                        </div>
                    </div>
                </section>
