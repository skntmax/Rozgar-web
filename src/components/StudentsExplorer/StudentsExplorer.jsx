...
const images = [
    "https://cp-devapi.rozgar.com/college/logo/1665644639116.jpg",
    studentBanner,
];
...
export default class StudentsExplorer extends Component {
    ...
    render() {
        const { ShowApplyNowPopUp, dataList, showData, firstName, lastName, mobile, email, course, city, open, photoIndex } = this.state
        return (
            <React.Fragment>
                {open && (
                    <Lightbox
                                                                    ...
                                                                    <div className='imgarea'>
                                                                        ...
                                                                        <div className='justify-content-between'>
                                                                            <div className='d-flex'>
                                                                                <Link onClick={() => this.setState({ open: true })} className='data-icon'><i class="fa fa-picture-o"></i> 2</Link>
