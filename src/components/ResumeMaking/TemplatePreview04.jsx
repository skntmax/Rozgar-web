...
import resume04 from '../../assets/img/demos/demo-view-4.png';
import constant from '../../constant';
import { getStorage } from '../../utils';


export default class TemplatePreview04 extends Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            <div className="col-12 col-md-9">
                                <div>
                                    <div className="blog_thumbnail">
                                        <img src={resume04} className="temp-img" alt="" />
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 col-md-3">
                                <div className="sidebar-area">
                                    <div className="temp-summary mt-4">
                                        ...
                                        <a className="dream-btn width-100" href={candidateID ? constant.component.updateTemplate04.url : constant.component.TemplateEdit04.url}>Try This Template</a>
                                    </div>
                                </div>
                            </div>
                        </div>
