                                        ...
                                        <div className="col">
                                            <div className="demo-item">
                                                ...
                                                <div className="preview-btn-wrapper text-center">
                                                    ...
                                                    <a href={candidateID ? constant.component.updateTemplate04.url : constant.component.TemplateEdit04.url} className="preview-demo v2" style={{ padding: "15px 10px" }}>Use template <i className="fa fa-long-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col">
                                            <div className="demo-item">
                                                ...
                                                <div className="preview-btn-wrapper text-center">
                                                    ...
                                                    <a href={candidateID ? constant.component.updateTemplate05.url : constant.component.TemplateEdit05.url} className="preview-demo v2" style={{ padding: "15px 10px" }}>Use template <i className="fa fa-long-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col">
                                            <div className="demo-item">
                                                ...
                                                <div className="preview-btn-wrapper text-center">
                                                    ...
                                                    <a href={candidateID ? constant.component.updateTemplate06.url : constant.component.TemplateEdit06.url} className="preview-demo v2" style={{ padding: "15px 10px" }}>Use template <i className="fa fa-long-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
