                                    ...
                                    <div class="col">
                                        <div className="row p-4" style={{ justifyContent: "space-between" }}>
                                            <div class="primary-info col-auto">
                                                <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">{detail.CANDIDATE_NAME}</h1>
                                                <div class="title mb-2" style={{ textTransform: "capitalize" }}>{detail.RESUME_HEADLINE}</div>
                                                <ul class="list-unstyled">
                                                    <li class="mb-0"><a class="text-link" href="#"><i class="far fa-envelope fa-fw me-2" data-fa-transform="grow-3"></i>{detail.EMAIL_ID}</a></li>
                                                    <li><a class="text-link" href="#"><i class="fas fa-mobile-alt fa-fw me-2" data-fa-transform="grow-6"></i>{detail.PHONENO}</a></li>
                                                </ul>
                                            </div>
