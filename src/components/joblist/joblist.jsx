                                ...
                                <div id="get_quote_frm">
                                    <div className="modal-content ">
                                        ...
                                        <div className="modal-body get_quote_view_modal_body">
                                            <p>You are saving alert for your search query <strong>'it'</strong></p>
                            ...
                            <div className="container">
                                <div className="row">
                                    <div id="rg-threecolumns" className="rg-threecolumns">
                                        {(JOB_COUNT != 0 || (filterdata.EXPERIENCE.length > 0 || filterdata.SALARY.length > 0 || filterdata.POSTED_BY.length > 0 || filterdata.WORK_FROM_HOME.length > 0 || filterdata.LOCATION.length > 0)) && <Filter hideExperience={this.props.hideExperience} getFilterData={(data) => this.filterData(data)} />}
                                        <div className={(JOB_COUNT != 0 || (filterdata?.EXPERIENCE.length > 0 || filterdata?.SALARY.length > 0 || filterdata.POSTED_BY?.length > 0 || filterdata?.WORK_FROM_HOME.length > 0 || filterdata?.LOCATION.length > 0)) ? "col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-6 float-left" : "col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9 float-left"}>
                                            <div className="rg-innersectionhead d-flex">
                                                <div className="rg-title">
                                                    <h2>{this.props.searchResultTitle ? this.props.searchResultTitle : 'Search Result'}</h2>
                                                </div>
                                            ...
                                            <div className="rg-featuredjobs rg-featuredjobsvtwo rg-featuredjobsvthree">
                                                ...
                                                {JOB_COUNT !== undefined && JOB_LIST !== undefined && JOB_LIST?.length > 0 && JOB_LIST.map((item, index) => {
                                                    ...
                                                    //                     </div>
                                                    //                     <div className="rg-description">
                                                    //                         <p>{item.JOB_DETAILS?.length > 64 ? Parser(item.JOB_DETAILS?.replace('Job description', '').slice(0, 64)) + '...' : Parser(item.JOB_DETAILS.replace('Job description', ''))}</p>
                                            ...
                                            <aside id="rg-sidebarvtwo" className="rg-sidebar rg-sidebarvtwo">
                                                {
                                                    this.props.isLocation && <div className="jobscitypage mb-20">
                                                        <ul>
                                                            ...
                                                            <li> <Link to={constant.component.topcompanieslist.url} ><i className="fa fa-caret-right"></i>Top Companies</Link></li>
                                                            <li> <Link to={constant.component.interviewQuestion.url} ><i className="fa fa-caret-right"></i>Interview Question</Link></li>
                                                            <li> <Link to={constant.component.studyAbroad.url} ><i className="fa fa-caret-right"></i>Study Abroad</Link></li>
                                                            <li> <Link to={constant.component.internationalWorkVisas.url} ><i className="fa fa-caret-right"></i>International Work Visa</Link></li>
                                                            <li> <Link to={constant.component.StudentsExplorer.url} ><i className="fa fa-caret-right"></i>Career Explorer</Link></li>
                                                            <li> <Link to={constant.component.careerAstrology.url} ><i className="fa fa-caret-right"></i>Career Astrology</Link></li>
                                                            <li> <Link to={constant.component.ResumeMaking.url} ><i className="fa fa-caret-right"></i>Resume Making</Link></li>
                                                            <li> <Link to={constant.component.educationLoan.url} ><i className="fa fa-caret-right"></i>Education Loan</Link></li>
