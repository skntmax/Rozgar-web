...
import { getFeaturedJobs, getRecommendedJobs, getSaveJobList, SaveJobs } from '../../action/CandidateAction'
...
export default class FeaturedJobs extends Component {
    ...
    componentDidMount() {
        ...
        this.FeaturedJobsList(this.state.pageNumber)
    ...
    FeaturedJobsList = (pageNumber) => {
        this.setState({ showLoader: true })
        getFeaturedJobs({ pageNumber: pageNumber }).then((res) => {
            if (res.status) {
                this.setState({ showLoader: false })
                setTimeout(() => {
                    this.setState({ showShimmer: false })
                }, 1000)
                this.setState({ list: res.result.featuredJobList, count: res.result.count.total })
    ...
    handlePageChange = (pageNumber) => {
        ...
        this.FeaturedJobsList(pageNumber)
    };
                                ...
                                <div className="row">
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div className="rg-title">
                                            <h3 className='text-white'>Featured Jobs for You</h3>
                                        </div>
                                    </div>
                                                        ...
                                                        <div className='row'>
                                                            <div className='col-md-12'>
                                                                {this.state.list && this.state.list.map((data) => {
                                                                    var a = moment([parseInt(moment(data.CREATED_ON).format('YYYY')), parseInt(moment(data.CREATED_ON).format('MM')), parseInt(moment(data.CREATED_ON).format('DD'))])
                                                                        ...
                                                                        <div className="rg-featurejobholder">
                                                                            ...
                                                                            <div className="rg-featurejob">
                                                                                <figure className="rg-companyimg" >
                                                                                    ...
                                                                                    {data.COMPANY_LOGO === 'NA' ? <h6 style={{ marginBottom: "0" }}>{data.COMPANY_NAME.split(' ').length === 1 ? data.COMPANY_NAME.slice(0, 1) : data.COMPANY_NAME.split(' ').map((i) => i.substring(0, 1)).join('').slice(0, 3)}</h6> : <img src={`${process.env.REACT_APP_BASE_URL}/company/logo/${data.COMPANY_LOGO}`} alt={data.COMPANY_NAME} />}
                                                                                </figure>
                                                                                ...
                                                                                <div className="rg-companycontent">
                                                                                    ...
                                                                                    <div className="rg-companyname">
                                                                                        ...
                                                                                        <div className="companyreviewbox">
                                                                                            {/* <a href="#"><span>Accent </span></a> */}
                                                                                            <span></span>
                                                                                            <span className="reviewnumber">{data.rating} <i className="fa fa-star"></i></span>
                                                                                    ...
                                                                                    <div className="rg-description">
                                                                                        ...
                                                                                        <ul className="skilllist">
                                                                                            <span> {data.KEYWORDS && data.KEYWORDS.length > 60 ? `${data.KEYWORDS.slice(0, 60)}...` : data.KEYWORDS}</span>
                                                                                        </ul>
                                                                                    </div>
                                                                                    <div className="rg-rightarea">
