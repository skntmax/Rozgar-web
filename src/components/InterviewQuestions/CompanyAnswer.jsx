...
InterviewQuestionById = (questionId) =>{
 ...
 AnswerById = (questionId) =>{
  ...
  onSearchQuestions = () => {
    console.log("d213",this.props.history.location.state);
                        ...
                        <div className="row">
                                    ...
                                    <div className='breadcrumb2'>
                                      <Link onClick={() => this.props.history.goBack()}>
                                        ...
                                        <li> <Link to ='/'>Home</Link><span class="arrow bold-small-grey-text"> &gt;</span></li>
                                            <li> <Link to = {constant.component.interviewQuestion.url}>Interview Questions</Link><span class="arrow bold-small-grey-text"> &gt;</span></li>
                                            <li> <Link onClick={() => this.props.history.goBack()}>{EMPLOYER_NAME}</Link> <span class="arrow bold-small-grey-text"> &gt;</span></li>
                                            {this.props.skill_Name?
                                              <li> <Link onClick={() => this.props.history.goBack()}>{this.props.skill_Name?this.props.skill_Name.map(j=>j.toUpperCase()).join():''}</Link></li>:null
                                            }
                                        </ul>
                                        </Link>
                                    </div>
                            ...
                            <div className="col-12 col-sm-12 col-md-4 col-lg-4">
                                ...
                                <div className='questions-top-designations-Box'>
                                    ...
                                    <Link to={constant.component.interviewQuestionByCompany.url}><div className='more-item-box'><a className='rg-onHoverButton'>Explore more Companies</a> </div></Link>
                                </div> 
