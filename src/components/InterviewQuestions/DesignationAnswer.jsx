                ...
                <div className="row">
                    ...
                    <div className='add-Answer-container'>
                      <div className='breadcrumb2'>
                        ...
                        <ul>
                          ...
                          <li> <Link onClick={() => this.props.history.goBack()}>{DESIGNATION.toUpperCase()}</Link></li>
                          {/* <li> <Link onClick={() => this.props.history.goBack()}>{this.props.skill_Name?this.props.skill_Name.toUpperCase():''}</Link></li> */}
                        </ul>
                  ...
                  <div className="col-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <div className='questions-top-designations-Box'>
                      ...
                      <Link to={constant.component.interviewQuestionByDesignation.url}><div className='more-item-box'><a className='rg-onHoverButton'>Explore more Designation</a> </div></Link>
                    </div>
