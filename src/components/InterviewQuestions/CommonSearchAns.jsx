...
import { addInterviewQuestionAnswer, answerById, CommonQuestionById, interviewQuestionById } from '../../action/SkillsQuestionAction';
...
componentDidMount(){
    ...
    console.log("List",this.props?.List1)
}
InterviewQuestionById = (questionId) =>{
    CommonQuestionById(questionId).then((res)=>{
      // console.log({list1:res.result})
...
const {skillId} = this.props.history.location.state
  ...
  render() {
    ...
    document.title = constant.title.commonInterviewAnswer.replace('Questions',List1?List1[0].QUESTION_TITLE:'')
                                ...
                                <div className='row'>
                                    <div className='col-md-12'>
                                        <div className='breadcrumbF'>
                                            <ul>
                                                <li><a href='/'>Home</a></li>
                                                <li className='active' onClick={()=>this.props.history.goBack()} style={{cursor:'pointer',color:'red'}}><a href=''></a>{List1?List1[0].QUESTION_TITLE.charAt(0).toUpperCase() + List1[0].QUESTION_TITLE.slice(1).replace(/ /g," "):null}</li>
                                            </ul>
                                        </div>
