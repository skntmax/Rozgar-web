...
export const LoginwithMobile = (data) => {
    const url = `${process.env.REACT_APP_BASE_URL}/CandidateLoginWithMob`;
    return axios.post(url, data).then((res) => {
        return res.data;
    })
};
...
export const LoginMobileOtpVerify = (data) => {
    const url = `${process.env.REACT_APP_BASE_URL}/CandidateLoginOtpVerify`;
    debugger
    return axios.post(url, data).then((res) => {
        console.log(res)
        if (res.data.status) {
